...
public class ThaumcraftPlugin {
	...
	public static boolean use() {
		return Loader.isModLoaded("Thaumcraft") && ConfigHandler.enableThaumcraft;
	}

	public static void register()
	{
		if (Loader.isModLoaded("Thaumcraft") && ConfigHandler.enableThaumcraft) {
			Plus.log.info("Thaumcraft detected. Registering aspects on blocks");
			try {
...
*/				
				...
				Plus.log.error("Error registring Thaumcraft Aspects on Plus blocks", e);
			}
		}
	}
	...
	private static void safeAdd(Block block, int num, int meta, AspectList aspects)
	{
		if (block != null) {
			...
			{
				Plus.log.error("Error registring Thaumcraft Aspects on Plus block " + block.getUnlocalizedName(), e);
			}
		}
	...
	private static void safeAdd(Item item, AspectList aspects)
	{
		if (item != null) {
			...
			{
				Plus.log.error("Error registring Thaumcraft Aspects on Plus item " + item.getUnlocalizedName(), e);
			}
		}
	}
}
